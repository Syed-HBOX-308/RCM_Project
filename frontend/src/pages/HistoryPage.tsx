                ...
                <div className="space-y-4">
                  {history.map((log) => (
                    <div key={log.id} className="bg-white/5 rounded-md p-4">
                      <div className="flex flex-wrap gap-x-6 gap-y-2 justify-between mb-3">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col gap-2 mt-3">
                        <div className="flex flex-wrap">
                          <div className="w-full md:w-1/4 mb-1 text-white/60">
                            Field Name:
                          </div>
                          <div className="w-full md:w-3/4 font-medium">
                        ...
                        <div className="flex flex-wrap">
                          ...
                          <div className="w-full md:w-3/4 bg-error-900/20 text-error-300 px-2 py-1 rounded">
                            {log.old_value || 'N/A'}
                          </div>
                        </div>
                        ...
                        <div className="flex flex-wrap">
                          ...
                          <div className="w-full md:w-3/4 bg-success-900/20 text-success-300 px-2 py-1 rounded">
                            {log.new_value || 'N/A'}
                          </div>
                        </div>
